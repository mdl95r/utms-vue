<template>
	<div ref="outsideClickRef" :class="[$style.dropdown, {[$style.dropdownopen]: isDropDownOpen}]">
...
<script>
	export default {
		...
		mounted() {
			const clickOutSide = this.$refs.outsideClickRef
			
			document.addEventListener('click', (e) => {
				if (!e.target.closest(`.${clickOutSide.classList[0]}`)) {
